{{ config(
    tags=["pl","hist","pl_hist"],
    snowflake_warehouse= env_var("DBT_WBX_SF_WH"),
    ) 
}}


with ibe_history_pl as 
(
    select * from {{ ref('src_ibe_history_pl') }}
)

select
        '{{ env_var("DBT_SOURCE_SYSTEM") }}' as source_system,
        TO_TIMESTAMP_NTZ(TO_CHAR(TO_TIMESTAMP_NTZ(Date, 'DD-Mon-YY'), 'YYYY-MM-DD HH24:MI:SS.000'))  as date,
