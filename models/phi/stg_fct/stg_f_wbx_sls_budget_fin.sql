...
with 
source as (select * from {{ref("src_wbx_budget_sku_pl")}}),

renamed as (

    select
        tratypcde,
        comcde_5_d as comcde5d,
...
final_cast as (
    select 
        cast(substring(tratypcde,1,2) as text(2) ) as tratypcde  ,
        cast(comcde5d as number(38,0) ) as comcde5d  ,
