{{
    config(
        ...
        tags=["sales_budget","budget","promo"],
        unique_key="frozen_forecast",
        incremental_strategy="delete+insert",
        snowflake_warehouse=env_var('DBT_WBX_SF_WH'),
        alias='fct_wbx_sls_budget_promo',
        transient=false,
...
/*  The 2 similar models, fct_wbx_sls_budget_promo and fct_wbx_sls_budget_terms are quarterly sales budget related data sets
    ...
    This map initially just copies over the historical data to the new model.  Subsequent runs copy the data from the promo history table based 
...
cte_fct as (select * from {{ ref('fct_wbx_sls_promo_hist') }}),
...
,src_old as(
    select 
        ...
        ,promo_code
        ,unique_key
     from {{ref('conv_fct_wbx_sls_budget_promo')}}
