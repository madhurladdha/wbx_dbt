...
/* 
    ...
    This needs to have the following udpates once the D365S table itself exists:
        -Change the source to source('D365S', 'ecoresdatetimevalue')
...
with source as (
    ...
    select * from {{ source('D365S', 'ecoresdatetimevalue') }} where _FIVETRAN_DELETED='FALSE'
),
...
renamed as (
    ...
    select
        ...
        datetimevalue as date_time_value,
        _fivetran_deleted
