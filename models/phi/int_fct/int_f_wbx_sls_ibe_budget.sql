...
{% set sign_flip = 1 %}
{% set company_code = 'IBE' %}
/*adding company code variable which is required for deriving currencies*/
with
fact as (
    select *
    ...
    where
        frozen_forecast in (
            ...
            from {{ ref("stg_f_wbx_sls_ibe_budget_fin") }}
        )
),
...
fct_wbx_sls_budget as (
    select
        ...
        * {{ sign_flip }} as ap_tot_prime_cost_standard_co_pack,
        ...
        old_budget.exp_consumer_spend_amt
    ...
    left join
        ...
        on
            ...
            /*21th Mar 2024 Adding currency conversion logic for ibe budget  */
    left join
