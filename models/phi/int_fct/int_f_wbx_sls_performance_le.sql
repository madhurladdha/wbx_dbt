...
select
    ...
    "CY Added Value Pack £" as "LE CY Added Value Pack £",
    ...
    * -1 as "LE CY Total Customer-Invoiced Trade Spend (Combo)",
    ...
    "(Budget) Forecast NRR £ (Combo)" as "LE (Budget) Forecast NRR £ (Combo)",
    ...
    "Budget Variable Trade £ (Combo)" as "LE Budget Variable Trade £ (Combo)",
    ...
    "CY Total Variable Trade £ (Combo)" as "LE CY Total Variable Trade £ (Combo)",
    "Forecast Non-Customer Invoiced Fixed Trade £ (Combo)"
    as "LE Forecast Non-Customer Invoiced Fixed Trade £ (Combo)",
    "Forecast PCOS £ (Combo) Act" as "LE Forecast PCOS £ (Combo) Act",
    "Forecast PCOS £ (Combo) Std" as "LE Forecast PCOS £ (Combo) Std",
    ...
    * -1 as "LE Budget Fixed Trade Spend",
    ...
    + - final."Forecast Total Variable Trade £" * -1 as "LE Cy Variable Trade Spend",
    ifnull(
        "CY Permanent Discounts £" + -1 * "Forecast Permanent Discounts £", 0
