...
with stage_table as (
    select * from {{ ref('stg_f_wbx_sls_order_ibehist') }}
),
...
trans_source as (
    ...
    from source
    left join {{ ent_dbt_package.lkp_normalization('source.source_system','LOGISTICS','SALES_ORDER_CODE','TO_CHAR((SOURCE_SALES_ORDER_TYPE))','ref_normalization_xref_sls_ordr_typ') }}
