...
select
    ...
    "Forecast Non-Customer Invoiced Fixed Trade £ (LIVE)"
    as "CW Forecast Non-Customer Invoiced Fixed Trade £ (LIVE)",
    "Forecast PCOS £ (LIVE) Act" as "CW Forecast PCOS £ (LIVE) Act",
    "Forecast PCOS £ (LIVE) Std" as "CW Forecast PCOS £ (LIVE) Std",
    ...
    "CY Added Value Pack £" as "CW CY Added Value Pack £",
    ...
    * -1 as "CW CY Total Customer-Invoiced Trade Spend (Combo)",
    ...
    "(Budget) Forecast NRR £ (Combo)" as "CW (Budget) Forecast NRR £ (Combo)",
    ...
    "Budget Variable Trade £ (Combo)" as "CW Budget Variable Trade £ (Combo)",
    ...
    "CY Total Variable Trade £ (Combo)" as "CW CY Total Variable Trade £ (Combo)",
    "Forecast Non-Customer Invoiced Fixed Trade £ (Combo)"
    as "CW Forecast Non-Customer Invoiced Fixed Trade £ (Combo)",
    "Forecast PCOS £ (Combo) Act" as "CW Forecast PCOS £ (Combo) Act",
    "Forecast PCOS £ (Combo) Std" as "CW Forecast PCOS £ (Combo) Std",
    ...
    * -1 as "CW Budget Fixed Trade Spend",
    ...
    + - final."Forecast Total Variable Trade £" * -1 as "CW Cy Variable Trade Spend",
    ifnull(
        "CY Permanent Discounts £" + -1 * "Forecast Permanent Discounts £", 0
