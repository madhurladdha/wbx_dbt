...
with
    table_a as (
        ...
        from {{ table_a }} where {{filter_field_a}} in {{filter_condition_a}} and {{and_condition_a}}
    ),
    ...
    table_b as (
        ...
        from {{ table_b }}
        where {{filter_field_b}} in {{filter_condition_b}} and {{and_condition_b}}
    ),
    final as (
        select
            table_a_count,
